...
urls = ["https://www.pakwheels.com/used-cars/search/-/mk_suzuki/md_alto/?page=",
...
for url in urls:
    for page in range(1, 4):
        ...
        for i, ul in enumerate(info):
            ...
            all_data.append([car_name, *car_info, pricesList[i]])

# create a pandas dataframe and save the data to a CSV file
df = pd.DataFrame(
    all_data, columns=["Car Name", "Year", "KM", "Type", "CC", "Transmission", "Price"]
)
